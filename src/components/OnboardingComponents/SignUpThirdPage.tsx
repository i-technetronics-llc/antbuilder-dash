...
export default function SignUpThirdPage({
  ...
  const [viewe, setViewe] = useState<string>("");
  return (
      ...
      {viewe === "" && (
        <div className="flex gap-4 flex-col">
          ...
          <div className="flex flex-col gap-1 w-full">
            ...
            <Select onChange={(e) => setIndustry(e.target.value)} size={"lg"}>
              <option value="Please Select Industry">
          ...
          <div className="flex flex-col gap-1 w-full">
            ...
            <Select onChange={(e) => setCountry(e.target.value)} size={"lg"}>
              <option value="Please Select Industry">
